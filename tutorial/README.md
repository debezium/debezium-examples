...
The Apicurio Registry integration has been moved to its own dedicated top-level example.
See the [apicurio](../apicurio/README.md) example for full details on all supported converter modes.
