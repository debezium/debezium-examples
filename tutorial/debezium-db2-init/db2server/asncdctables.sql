...
CREATE OR REPLACE PROCEDURE INSERT_APP_LEVEL_IF_NOT_YET_DONE
    LANGUAGE SQL
BEGIN
    IF NOT EXISTS(SELECT 1 FROM ASNCDC.IBMSNAP_APPLEVEL)
    THEN
        INSERT INTO ASNCDC.IBMSNAP_APPLEVEL(ARCH_LEVEL) VALUES ('1021');
    END IF;
END;

CALL INSERT_APP_LEVEL_IF_NOT_YET_DONE();
...
CREATE OR REPLACE PROCEDURE INSERT_PARAMS_IF_NOT_YET_DONE
    LANGUAGE SQL
BEGIN
    IF NOT EXISTS(SELECT 1 FROM ASNCDC.IBMSNAP_CAPPARMS)
    THEN
...
CALL INSERT_PARAMS_IF_NOT_YET_DONE();
...
CREATE OR REPLACE PROCEDURE INSERT_SCHEMAS_IF_NOT_YET_DONE
    LANGUAGE SQL
BEGIN
    IF NOT EXISTS(SELECT 1 FROM ASNCDC.IBMSNAP_CAPSCHEMAS)
    THEN
        INSERT INTO ASNCDC.IBMSNAP_CAPSCHEMAS(CAP_SCHEMA_NAME) VALUES ('ASNCDC');
    END IF;
END;

CALL INSERT_SCHEMAS_IF_NOT_YET_DONE();
